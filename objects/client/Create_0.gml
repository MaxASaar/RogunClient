...
server_welcome_socket = network_create_socket(network_socket_tcp);
var server = network_connect_raw(server_welcome_socket , "127.0.0.1", 8192);
...
if server < 0
	...
	network_send_raw(server_welcome_socket, t_buffer, buffer_tell(t_buffer));
